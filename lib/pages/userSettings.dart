                    ...
                    Container(
                        ...
                        child: Column(children: [
                          GestureDetector(
                            onTap: () async {
                              String roleIdValue =
                                  await getUserRole(firebaseUIDValue!);
                              setSession("role", roleIdValue);

                              Navigator.pushReplacement(context,
                                  MaterialPageRoute(builder: (context) {
                                return const InstructorMainMenu(
                                    selectedInitIndex: 4,
                                    subSelectedInitIndex: 12);
                              }));
                            },
                            child: Container(
              ...
              Container(
                  child: Column(
                    ...
                    Container(
                        margin: const EdgeInsets.only(
                            top: 20, right: 20, left: 20, bottom: 10),
                        child: const Text("Support & About",
                            style: TextStyle(
                                fontSize: 18, fontWeight: FontWeight.bold))),
                    Container(
                        alignment: Alignment.center,
                        ...
                        child: Column(children: [
                          Container(
                            ...
                            child: Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                                  Icon(Icons.subscriptions_outlined, size: 30),
                                  SizedBox(
                                      width: MediaQuery.of(context).size.width /
                                          15),
