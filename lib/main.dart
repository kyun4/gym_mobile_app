...
import 'package:fitup/firebase_options.dart';
import 'package:fitup/components/AuthGate.dart';
...
void main() async {
  ...
  runApp(MultiProvider(providers: [
    ...
    ChangeNotifierProvider<FirebaseServices>(create: (_) => FirebaseServices()),
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        theme: ThemeData(
          ...
          // the application has a purple toolbar. Then, without quitting the app,r
